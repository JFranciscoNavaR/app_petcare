                                ...
                                <tr>
                                    ...
                                    <td width="50px">
                                        <a class="btn btn-danger btn-sm"
                                            wire:click="$emit('alert_delete_type', {{ $item->id }})">
            ...
            <div class="row g-2">
                <div class="col">
                    <div class="form-floating mb-3">
                        <input type="text" wire:model="type.nombre" required class="form-control" id="floatingInput"
            ...
            <div class="row g-2">
                <div class="col">
                    <div class="form-floating">
                        <textarea class="form-control" wire:model="type.descripcion"
                            placeholder="Descripción del tipo" id="floatingTextarea"></textarea>
